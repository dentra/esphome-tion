...
У меня можно приобрести готовый переходник для подключения стика
[Lilygo T-Dongle S3](https://github.com/Xinyuan-LilyGO/T-Dongle-S3) (доступность утоняйте).
...
Необходимо настроить MQTT согласно описанию из секции выше и установить
