...
[version-shield]: https://img.shields.io/static/v1?label=Версия&message=2024.1.3&color=green
...
Необходимо настроить `mqtt` согласно описанию из секции выше и установить установить шаблон
