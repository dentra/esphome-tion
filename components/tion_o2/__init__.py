...
TionO2ApiComponent = tion.tion_ns.class_(
    "TionO2ApiComponent", cg.Component, tion.TionApiComponent
)

CONFIG_SCHEMA = tion.tion_schema_api(TionO2ApiComponent, TionO2Api)


async def to_code(config: dict):
    await tion.setup_tion_api(config, "o2")
