...
class Component {
 public:
   ...
   */
  virtual float get_setup_priority() const { return this->setup_priority_override_; }

  // float get_actual_setup_priority() const;

  void set_setup_priority(float priority) { this->setup_priority_override_ = priority; }
  ...
  uint32_t get_component_state() const { return this->component_state_; }
  ...
  void status_set_warning(const char *message = "unspecified") { this->component_state_ |= STATUS_LED_WARNING; }
  void status_set_error(const char *message = "unspecified") { this->component_state_ |= STATUS_LED_ERROR; }
...
class PollingComponent : public Component {
 public:
   ...
   * @param update_interval The update interval in ms.
   */
  virtual void set_update_interval(uint32_t update_interval) { this->update_interval_ = update_interval; }
